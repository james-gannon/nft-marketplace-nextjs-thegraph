...
async function main() {
    ...
    console.log(`Working with contact address ${contractAddress}`)

    let itemListedOptions = {
        // Moralis interprets a local chain as 1337
    ...
    // Send these events up to our server
    ...
    if (listedResponse.success && canceledResponse.success && boughtResponse.success) {
        ...
        console.colg("Something went wrong :(")
    }
}
